...
<vs:stubVirtualService xmlns:vs="http://wu.com/stubio/config" environment="QA" lastUpdated="2026-04-02" name="CustomVirtualService">
    ...
    <vs:RestService allowFallback="false" autoRestart="true" contextPath="/" host="localhost" isSecured="false" port="8089">
        ...
        <vs:Endpoints>
            <vs:Endpoint method="GET" path="/admin/service" defaultRR="43657843">
                <vs:DataSourceSelect>
                    <vs:Database/>
                    <vs:File>
                ...
                <vs:RRPair id="43657843">
                    ...
                    <vs:ResponseSelection>
                        ...
                        <vs:MatchScript>
                            ...
                            <vs:Script><![CDATA[
matchContext.setResponse("DefaultSuccess")
return true
]]></vs:Script>
                        </vs:MatchScript>
                    </vs:ResponseSelection>
...
&lt;/user&gt;</vs:Body>
    ...
    "amount": 250
                    ...
                    <vs:ResponseSet>
                        <vs:Response contentType="application/json" httpMsg="OK" name="DefaultSuccess" responseDelay="0" statusCode="200">
                            <vs:Body><![CDATA[{"matched":"BODY_HEADER_QUERY","response":"DefaultSuccess"}]]></vs:Body>
                            <vs:ResponseScript>
                                <vs:ScriptLang>Groovy</vs:ScriptLang>
                                <vs:Script/>
                            </vs:ResponseScript>
                ...
                <vs:RRPair id="74657436">
                    ...
                    <vs:ResponseSet>
                        <vs:Response contentType="application/json" httpMsg="OK" name="HeaderOnlyMatched" responseDelay="0" statusCode="200">
                            <vs:Body><![CDATA[{"matched":"HEADER_ONLY"}]]></vs:Body>
                ...
                <vs:RRPair id="74657437">
                    ...
                    <vs:ResponseSet>
                        <vs:Response contentType="application/json" httpMsg="OK" name="QueryOnlyMatched" responseDelay="0" statusCode="200">
                            <vs:Body><![CDATA[{"matched":"QUERY_ONLY"}]]></vs:Body>
                            <vs:ResponseScript><vs:ScriptLang>Groovy</vs:ScriptLang><vs:Script/></vs:ResponseScript>
